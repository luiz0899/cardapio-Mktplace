...
public class AuthController {
	...
	public ResponseEntity<?> logar (
		...
		Authentication tokenAutentication = authenticationManager
				.authenticate(new UsernamePasswordAuthenticationToken
						(solicitacao.getLogin(), solicitacao.getSenha()));
		
		Preconditions.checkArgument(tokenAutentication.isAuthenticated(),
				"Login e/ ou senha inválidos ");
		
		String tokenGerado = gerenciadorDeToken.gerarTokenPorLogin(solicitacao.getLogin());
