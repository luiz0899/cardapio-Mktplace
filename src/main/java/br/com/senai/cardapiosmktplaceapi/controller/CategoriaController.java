...
public class CategoriaController {
	...
	public ResponseEntity<?> inserir(
		...
		Preconditions.checkArgument(!categoria.isPersistido(),"Acategoria não"
				+ "inserção pode possuir id na ");
	...
	public ResponseEntity<?> listarPor(
		...
		Page<Categoria> categoria = service.listarPor(nome, status, tipoDeCategoria, paginacao);
