...
public class GerenciadorDeTokenJwt {
	...
	public boolean isValidado(String tokenGerado , UserDetails credencial) {
		
		String login = extrairLoginDo(tokenGerado);
		boolean isLoginValidado = login.equals(credencial.getUsername());
		boolean isDentroDaValidade = !isVencido(tokenGerado);
		return isLoginValidado && isDentroDaValidade ;
