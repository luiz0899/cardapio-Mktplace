...
public class Cardapio {
	...
	@Size(max = 100, message = "O nome do cardapio deve conter 100 caracteres")
	@NotBlank(message = "O nome do cardapio é obrigatório")
	@Column(name = "nome")
	private String nome;
	
	@NotBlank(message = "A descrição do cardapio é obrigatória")
